...
| Bouzidi, M., Firdaouss, M., Lallemand, P.: *Momentum transfer of a Boltzmann-lattice fluid with boundaries.* Phys. Fluids 13(11), 3452-3459 (2001); DOI 10.1063/1.1399290. | The interpolated bounce-back (q-LIBB) scheme behind sub-cell-precise VG vane surfaces (`buildVaneQLinks` + the Bouzidi branch in `lbm_core.cu`): store the true link-cut fraction q and interpolate the reflected population to that position (two-branch linear; q>=1/2 single-node, q<1/2 two-node) instead of snapping the wall to q=0.5. Stair-stepping gone at the same resolution. |
| Yu, D., Mei, R., Luo, L.-S., Shyy, W.: *Viscous flow computations with the method of lattice Boltzmann equation.* Prog. Aerospace Sci. 39(5), 329-367 (2003); DOI 10.1016/S0376-0421(03)00003-4. | The "unified" single-branch interpolated boundary treatment (smooths Bouzidi's q-branch discontinuity); evaluated as the alternative to the two-branch form. |
| Mei, R., Luo, L.-S., Shyy, W.: *An accurate curved boundary treatment in the lattice Boltzmann method.* J. Comput. Phys. 155(2), 307-330 (1999); DOI 10.1006/jcph.1999.6334. | The Filippova-Hanel fictitious-equilibrium curved-wall scheme with the chi blend; documented as the LESS stable choice near tau=0.5 (its chi denominators blow up), so deliberately NOT used for this tau-clamped solver. |
| Ginzburg, I., d'Humieres, D.: *Multireflection boundary conditions for lattice Boltzmann models.* Phys. Rev. E 68, 066614 (2003); DOI 10.1103/PhysRevE.68.066614. | The TRT-consistent link-wise wall closure: applying the q-correction to the anti-symmetric population makes the wall location viscosity-independent. |
